...
REGISTRY: dict = {
    ...
    "tick":        _entry(make_tick,     TICK_PARAMS,        "percussion"),
    "clock":       _entry(make_clock,    CLOCK_PARAMS,       "percussion"),
    "anvil":       _entry(make_anvil,    ANVIL_PARAMS,       "percussion"),
    "slam":        _entry(make_slam,     SLAM_PARAMS,        "percussion"),
    "tap":         _entry(make_tap,      TAP_PARAMS,         "percussion"),
    # strings
    ...
    "boom":          _entry(make_boom,        BOOM_PARAMS,         "fx"),
